...
export { storage, ref ,app, db,signOut ,createUserWithEmailAndPassword,signInWithEmailAndPassword, collection, addDoc, getFirestore, getDocs, query, where, auth, RecaptchaVerifier, signInWithPhoneNumber}